...
import { createUserSchema, resetUserPasswordSchema, updateUserSchema } from "@/lib/user-management/user.schema";
import { useCreateUserMutation, useDeleteUserMutation, useResetUserPasswordMutation, useToggleUserMutation, useUpdateUserMutation } from "@/mutations/user-management/user.mutation";
import { useRolesLiteQuery, useUsersQuery } from "@/queries/user-management/user.query";
...
export default function UsersPage() {
  ...
  function openEdit(user: UserItem) {
    ...
    setEditForm({ name: user.name ?? "", email: user.email ?? "", phone: user.phone ?? "", role: getUserRole(user) === "—" ? "" : getUserRole(user) });
    setEditOpen(true);
  }
