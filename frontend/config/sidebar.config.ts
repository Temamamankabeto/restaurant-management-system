...
export const sidebarConfig: Record<AppRoleKey, RoleSidebar> = {
  "cafeteria-manager": roleSidebar("cafeteria-manager", Store, Store, [
    ...
    { label: "All Orders", href: "/dashboard/orders", permission: "orders.read" },
    { label: "Create Order", href: "/dashboard/orders/create", permission: "orders.create" },
  ...
  cashier: roleSidebar("cashier", CreditCard, CreditCard, [
    { label: "POS Orders", href: "/dashboard/pos/orders" },
    { label: "Create POS Order", href: "/dashboard/pos/orders/create" },
